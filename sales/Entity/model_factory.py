...
RANDOM_SEARCH_KEY = 'random_search'
MODULE_KEY = 'module'
CLASS_KEY = 'class'
PARAM_KEY = 'params'
...
RandomSearchedBestModel = namedtuple("randomSearchedBestModel", ["model_serial_number", "model", "best_model",
        ...
        model_config = {
            ...
            MODEL_SELECTION_KEY: {
                "module_0": {
                    ...
                    PARAM_KEY: {"param_name1": "value1", "param_name2": "value2", "param_name3": "value3",
                                "param_name4": "value4", },
                    SEARCH_PARAM_RANDOM_KEY: {"param_name": ['param_value_1', 'param_value_2']}
                },
            }
        }
...
class ModelFactory:
    def __init__(self, model_config_path: str = None):
        try:
            ...
            self.random_search_cv_module: str = self.config[RANDOM_SEARCH_KEY][MODULE_KEY]
            self.random_search_class_name: str = self.config[RANDOM_SEARCH_KEY][CLASS_KEY]
            self.random_search_property_data: dict = dict(self.config[RANDOM_SEARCH_KEY][PARAM_KEY])
    ...
    def execute_random_search_operation(self, initialized_model: InitializedModelDetail, input_feature,
                                        output_feature) -> RandomSearchedBestModel:
        """
        execute_random_search_operation(): function will perform parameter search operation and,
        it will return you the best optimistic  model with best-parameter:
        estimator: Model object
        param_random: dictionary of parameter to perform search operation
        input_feature: all your input features
        output_feature: Target/Dependent features
        ================================================================================
        return: Function will return randomSearchOperation object
        """
        try:
            # instantiating randomSearchCV class

            random_search_cv_ref = ModelFactory.class_for_name(module_name=self.random_search_cv_module,
            ...
            random_search_cv = ModelFactory.update_property_of_class(random_search_cv,
            ...
            random_searched_best_model = RandomSearchedBestModel(
    ...
    def initiate_best_parameter_search_for_initialized_models(self,
                                                              ...
                                                              input_feature,
                                                              output_feature) -> List[RandomSearchedBestModel]:
    ...
    @staticmethod
    def get_best_model_from_random_searched_best_model_list(
            random_searched_best_model_list: List[RandomSearchedBestModel],
            base_accuracy=0.6
    ) -> BestModel:
        try:
            best_model = None
    ...
    def get_best_model(self, X, y, base_accuracy=0.6) -> BestModel:
        try:
            ...
            return ModelFactory.get_best_model_from_random_searched_best_model_list(random_searched_best_model_list,
