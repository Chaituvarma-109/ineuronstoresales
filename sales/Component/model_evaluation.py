...
from sales.Entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact, ModelTrainerArtifact, \
    ModelEvaluationArtifact
from sales.utils.util import write_yaml_file, read_yaml_file, load_object, load_data
from sales.Component.model_trainer import evaluate_regression_model
...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            metric_info_artifact = evaluate_regression_model(model_list=model_list, X_train=train_dataframe,
                                                             y_train=train_target_arr, X_test=test_dataframe,
