...
from sales.Entity.model_factory import ModelFactory, MetricInfoArtifact, RandomSearchedBestModel, \
    evaluate_regression_model
from sales.Config.configuration import ModelTrainerConfig
from sales.utils.util import load_numpy_array_data, save_object, load_object
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            random_searched_best_model_list: List[
                RandomSearchedBestModel] = model_factory.random_searched_best_model_list
            ...
            housing_model = SalesEstimatorModel(preprocessing_object=preprocessing_obj,
