...
from sales.Constants import CONFIG_DIR, get_current_time_stamp
from sales.utils.util import read_yaml_file, write_yaml_file
from sales.Logger.log import logging, get_log_dataframe
...
def render_artifact_dir(req_path):
    ...
    files = {os.path.join(abs_path, file_name): file_name for file_name in os.listdir(abs_path) if "artifact" in
             os.path.join(abs_path, file_name)}
